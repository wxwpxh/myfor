...
!	$ cd ../recipes/
!	$ cp ../other/*.mod .
!	$ gfortran -B. -c ../examples/xlinbcg.f90
!	$ gfortran -B. -c *.f90 -fno-range-check
!	$ ar rcs librecipes.a *.o
!	$ mv librecipes.a ../examples/.
!	$ cd ../examples/
!	$ cp ../other/*.mod .
!	$ cp ../data/*.DAT .
!	$ gfortran -B. -L. -o xflmoon xflmoon.f90 -lrecipes
	PROGRAM xflmoon
